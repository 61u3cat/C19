...
class Info_services_controller extends Controller
{
    ...
    public function store(Request $request)
    {
        if ($request->hasFile('icon_image')) {
            if ($request->file('icon_image')->isValid()) {
                ...
                return redirect()->route('info.index')->with('message', 'Successfully created Information Services');
            }
        } else {
            Info_services::create([
                'service_name' => $request->service_name,
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('icon_image')) {
            if ($request->file('icon_image')->isValid()) {
                ...
                return redirect()->route('info.index')->with('message', 'Successfully updated Information Services');
            }
        } else {
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('info.index')->with('message', 'Successfully deleted Information Services');
    }
}
