...
class Dashboard_controller extends Controller
{
    ...
    {
//        $infected_update = DB::table('corona_update_bans')->orderBy('created_at', 'DESC')->first();
//        $death_update = DB::table('corona_update_bans')->orderBy('created_at', 'DESC')->first();
//        $cure_update = DB::table('corona_update_bans')->orderBy('created_at', 'DESC')->first();
//        $test_update = DB::table('corona_update_bans')->where('case','test')->orderBy('created_at', 'DESC')->first();
        ...
        return view('admin.homepage', compact('total_videos', 'total_services', 'total_news'));
