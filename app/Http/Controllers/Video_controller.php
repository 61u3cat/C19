...
class Video_controller extends Controller
{
    ...
    public function store(Request $request)
    {
        if ($request->hasFile('video_thumbnail')) {
            if ($request->file('video_thumbnail')->isValid()) {
                ...
                return redirect()->route('videos.index')->with('message', 'Successfully updated videos');
            }
        } else {
            important_video::create([
                'video_link' => $request->video_link,
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('videos.index')->with('message', 'Successfully deleted videos');
    }
}
